...
class Workspace(models.Model):
    ...
    owner = models.ForeignKey(Member, on_delete=models.PROTECT, related_name='workspace_owner')
...
class Collection(models.Model):
    ...
    A Collection is the 
    """
    workspace = models.ForeignKey(Workspace, related_name='collections', on_delete=models.CASCADE)
...
class CollectionItem(models.Model):
    ...
    name = models.TextField(
        ...
        max_length=128)
    added_by = models.ForeignKey(Member, on_delete=models.PROTECT, related_name='added')
    ...
    state = models.CharField(max_length=32,
                             ...
                             default=State.ADDED)
    bought_by = models.ForeignKey(Member, null=True, on_delete=models.PROTECT, related_name='bought')
